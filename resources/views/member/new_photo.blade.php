<?php
    $pageTitle = htmlspecialchars_decode($post->title);
?>
...
@section('content')
        ...
        <!-- Content area below -->
            @if( session('infoMessage') || session('infoMessage') )
            <!-- Message -->
            <div class="col-sm-12">
            ...
            <form method="post" action="{{ route('post_photo.upload', $post->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="input-group col-lg-6 col-md-6">
                                    <div class="input-group-addon">
                                      <a href="{{ route('post.view', [$post->id,]) }}" style="color: black;">
