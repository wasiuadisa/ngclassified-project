...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/assets/css/rangeslider.css') }}">
...
@yield('content')
  ...
  <script src="{{ asset('storage/assets/js/bootstrap-datepicker.min.js') }}"></script>
  <script src="{{ asset('storage/assets/js/aos.js') }}"></script>
  <script src="{{ asset('storage/assets/js/rangeslider.min.js') }}"></script>
